...
This page provides procedures and guidelines for developing and contributing to lsst-cst.

Scope of contributions
======================

lsst-cst is an open source package, meaning that you can contribute to lsst-cst itself, or fork lsst-cst for your own purposes.

Since lsst-cst is intended for internal use by Rubin Observatory, community contributions can only be accepted if they align with Rubin Observatory's aims.
For that reason, it's a good idea to propose changes with a new `GitHub issue`_ before investing time in making a pull request.

lsst-cst is developed by the Rubin Observatory SQuaRE team.

.. _GitHub issue: https://github.com/lsst/lsst-cst/issues/new
...
To develop lsst-cst, create a virtual environment with your method of choice (like virtualenvwrapper) and then clone or fork, and install:
...
1. Installs lsst-cst in an editable mode with its "dev" extra that includes test and documentation dependencies.
...
lsst-cst uses scriv_ to maintain its change log.
